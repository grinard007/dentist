...
<section class="welcome-area">
  ...
  <div class="welcome-slides owl-carousel">
    ...
    <div class="welcome-welcome-slide bg-img bg-gradient-overlay jarallax" style="background-image: url(<?php echo url('/'); ?>/img/bg-img/1.jpg);">
          ...
          <div class="col-12">
            ...
            <div class="welcome-text text-center">
              ...
              <div class="welcome-btn-group">
                <a href="#" style="border-radius: 20%;" class="btn dento-btn mx-2" data-animation="fadeInUp" data-delay="500ms">Get Started</a>
                <a href="{{ route('c') }}" style="border-radius: 20%;" class="btn dento-btn mx-2 active" data-animation="fadeInUp" data-delay="700ms">Contact Us</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Single Welcome Slide -->
    <div class="welcome-welcome-slide bg-img bg-gradient-overlay jarallax" style="background-image: url(<?php echo url('/'); ?>/img/bg-img/dental-1l.jpg);">
      <div class="container h-100">
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <!-- Welcome Text -->
            <div class="welcome-text text-center">
              ...
              <p data-animation="fadeInDown" data-delay="300ms">As a leading industry innovator, Dento is opening up exciting new opportunities for dental professionals, investors, employees & suppliers. Contact us to find out what we have to
                offer you.</p>
              <div class="welcome-btn-group">
                <a href="#" style="border-radius: 20%;" class="btn dento-btn mx-2" data-animation="fadeInDown" data-delay="500ms">Get Started</a>
                <a href="{{ route('c') }}" style="border-radius: 20%;" class="btn dento-btn mx-2 active" data-animation="fadeInDown" data-delay="700ms">Contact Us</a>
              </div>
            </div>
          </div>
        </div>
...
<section class="dento-about-us-area section-padding-100-0">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6">
          <div class="about-us-thumbnail mb-50">
            <img src="<?php echo url('/'); ?>/img/bg-img/d2.jpg" alt="">
          </div>
        </div>
        <!-- About Content -->
        <div class="col-12 col-md-6">
  ...
  <section class="dento-service-area section-padding-100-0 bg-img bg-gradient-overlay jarallax clearfix" style="background-image: url('<?php echo url('/'); ?>/img/bg-img/13.jpg');">
    <div class="container">
      <div class="row align-items-center">
        <!-- Service Content -->
            ...
            <div class="row">
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="<?php echo url('/'); ?>/img/core-img/s1.png" alt="">
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="<?php echo url('/'); ?>/img/core-img/s2.png" alt="">
                  <h6>Missing Teeth</h6>
                </div>
              </div>
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="<?php echo url('/'); ?>/img/core-img/s3.png" alt="">
                  <h6>Teeth Whitening</h6>
                </div>
              </div>
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="<?php echo url('/'); ?>/img/core-img/s4.png" alt="">
              ...
              <div class="col-6 col-md-4">
                <div class="single-service mb-70">
                  <img src="<?php echo url('/'); ?>/img/core-img/s5.png" alt="">
                  <h6>Examination</h6>
                </div>
              </div>
        ...
        <div class="col-12 col-lg-6">
          ...
          <iframe width="560" height="360" src="https://www.youtube.com/embed/x__UKyu0gFU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="more-btn text-center mt-50">
            <a href="#" style="border-radius: 20%;" class="btn dento-btn">Read More <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="book" class="book-an-oppointment-area section-padding-100 bg-img bg-gradient-overlay jarallax clearfix" style="background-image: url('img/bg-img/12.jpg');">
    <div class="container">
      <div class="row">
        <!-- Section Heading -->
        <div class="col-12">
          ...
          <div class="appointment-form">
            <form action="{{ route('appoint') }}" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group mb-30">
                    <input type="text" name="yourphone" class="form-control" placeholder="Your Phone" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group mb-30">
                ...
                <div class="col-md-6">
                  <div class="form-group mb-30">
                    <input type="text" name="youraddress" class="form-control" placeholder="Your Address">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group mb-30">
                    <select name="yourscheldule" class="form-control">
                ...
                <div class="col-md-6">
                  <div class="form-group mb-30">
                    <select name="yourday" class="form-control">
                      <option value="Choose Your Day">Choose Your Day</option>
                ...
                <div class="col-12">
                  <div class="form-group mb-30">
                    <textarea name="yourmessage" class="form-control" placeholder="Your Message"></textarea>
                  </div>
                </div>
                <div class="col-12 text-center">
                  <button type="submit" name="submt" style="border-radius: 20%;" class="btn dento-btn">Booking Now</button>
                </div>
              </div>
            </form>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="single-dentist-area mb-100">
            <img src="<?php echo url('/'); ?>/img/bg-img/d3.jpg" alt="">
            <!-- Dentist Content -->
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="single-dentist-area mb-100">
            <img src="<?php echo url('/'); ?>/img/bg-img/d5.jpg" alt="">
            <!-- Dentist Content -->
            <div class="dentist-content">
              <!-- Social Info -->
              <div class="dentist-social-info">
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="single-dentist-area mb-100">
            <img src="<?php echo url('/'); ?>/img/bg-img/d4.jpg" alt="">
            <!-- Dentist Content -->
            <div class="dentist-content">
              <!-- Social Info -->
              <div class="dentist-social-info">
  ...
  style="background-image: url('<?php echo url('/'); ?>/img/bg-img/7.jpg');">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <!-- Testimonials Slides -->
          <div class="testimonials-slides owl-carousel">
            ...
            <div class="single-testimonial-slide d-flex align-items-center">
              ...
              <div class="testimonial-thumb">
                <img src="<?php echo url('/'); ?>/img/bg-img/d6.jpg" alt="">
              </div>
              <!-- Content -->
            ...
            <div class="single-testimonial-slide d-flex align-items-center">
              <!-- Thumbnail -->
              <div class="testimonial-thumb">
                <img src="<?php echo url('/'); ?>/img/bg-img/d7.jpg" alt="">
              </div>
              <!-- Content -->
              <div class="testimonial-content">
                <h5>“I'd been avoiding the dentist for years due to bad experiences. A reminder SMS is sent the working day beforehand. I also had a call confirming appointment. I have been a patient ever since. My dentist is very reassuring and
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            ...
            <div class="blog-content">
              ...
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i>13 july 2020</a>

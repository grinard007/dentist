      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-service--area text-center mb-50">
            <div class="icon--">
              <img src="<?php echo url('/'); ?>/img/core-img/s6.png" alt="">
            </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-service--area text-center mb-50">
            <div class="icon--">
              <img src="<?php echo url('/'); ?>/img/core-img/s7.png" alt="">
            </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-service--area text-center mb-50">
            <div class="icon--">
              <img src="<?php echo url('/'); ?>/img/core-img/s8.png" alt="">
            </div>
            <h5>Missing Teeth</h5>
            <p>In pretium neque a libero congue. Elit diam lectus. Prasent lacinia vitae sit
              mattis mollis maximus.</p>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-service--area text-center mb-50">
            <div class="icon--">
              <img src="<?php echo url('/'); ?>/img/core-img/s9.png" alt="">
            </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="single-service--area text-center mb-50">
            <div class="icon--">
              <img src="<?php echo url('/'); ?>/img/core-img/s10.png" alt="">
            </div>
            <h5>Examination</h5>
            <p>In pretium neque a libero congue. Elit diam lectus. Prasent lacinia vitae sit
              mattis mollis maximus.</p>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            ...
            <div class="blog-content">
              <a href="{{ route('bd')}}" class="post-title">How your mouth bacteria can harm your lungs</a>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            ...
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="{{ route('bd')}}" class="post-title">What is the best kind of toothpaste to use?</a>
              <p>Donec tempor, lorem et euismod eleifend, est lectus laoreet ante, sed accusan justo diam ...</p>
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i>13 july 2020</a>
                <a href="#"><i class="icon_chat_alt"></i> 3 Comments</a>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="single-blog-item mb-100">
            ...
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="{{ route('bd')}}" class="post-title">Why you should avoid sipping your drinks</a>
              <p>Donec tempor, lorem et euismod eleifend, est lectus laoreet ante, sed accusan justo diam ...</p>
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i> 13 july 2020</a>
                <a href="#"><i class="icon_chat_alt"></i> 3 Comments</a>
